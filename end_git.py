#!/usr/bin/env python3
"""end_git — push project context to Git.

Cross-platform replacement for end_git.cmd.

Usage:
    python end_git.py [target] [agent]
    python end_git.py agent-factory
"""
...
def main() -> None:
    ...
    print(f"[SYNC END] pushing to Git  target={target}  agent={agent or '(all)'}")

    cmd = [sys.executable, str(GIT_SYNC), "--mode", "push"]
