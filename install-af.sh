...
c_yellow "    af setup"
echo ""
echo "  AI 프로바이더(Claude/Gemini/Codex) 설치 및 인증:"
c_yellow "    af provider install   # npm으로 미설치 프로바이더 자동 설치"
c_yellow "    af provider auth      # 프로바이더 인증 (계정 로그인)"
c_yellow "    af provider status    # 설치·인증 상태 확인"
