...
- owner: frontend_dev
- objective: working implementation output을(를) 구현한다.
- deliverables: working implementation output
- feature_slices: working implementation output을(를) 구현한다.
...
- (시작) → **working implementation output**
- (시작) → **Backend Dev 구현**
- (시작) → **QA Engineer 검증**
