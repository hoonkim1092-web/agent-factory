...
| 섹션 | 원본 경로 |
|------|----------|
| §2.1 실행 엔진 (Runtime Engine) | `docs/code_review/code-review.md:37` |
| §2.2 Control Plane (Sidecar 유지보수) | `docs/code_review/code-review.md:55` |
| §2.3 Provider 레이어 | `docs/code_review/code-review.md:79` |
| §2.4 Hook 시스템 | `docs/code_review/code-review.md:93` |
| §2.5 메모리 시스템 | `docs/code_review/code-review.md:113` |
| §2.6 ISE (Iterative Self-Enhancement) | `docs/code_review/code-review.md:136` |
| §2.7 스킬 시스템 | `docs/code_review/code-review.md:151` |
| §2.8 대화/연구 엔진 | `docs/code_review/code-review.md:188` |
| §2.9 파이프라인/보드 | `docs/code_review/code-review.md:204` |
| §2.10 인프라/유틸리티 | `docs/code_review/code-review.md:214` |
| §2.11 기타 | `docs/code_review/code-review.md:234` |
| §2.12 진입점 및 빌드 | `docs/code_review/code-review.md:252` |
| §3.1 Critical — 크래시 또는 데이터 손실 가능 | `docs/code_review/code-review.md:265` |
| §3.2 High — 잘못된 동작 | `docs/code_review/code-review.md:274` |
| §3.3 Medium — 성능/유지보수 | `docs/code_review/code-review.md:310` |
| §3.4 이미 수정된 버그 (control/ 영역) | `docs/code_review/code-review.md:335` |
| §3.5 신규 기능 추가 (2026-04-03) | `docs/code_review/code-review.md:348` |
