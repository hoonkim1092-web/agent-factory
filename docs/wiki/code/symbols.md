---
generated_at: 2026-06-25T18:45:03+09:00
...
## `scripts/build_knowledge_wiki.py`
...
## `scripts/measure_cot_variability.py`

**Functions:**
- `_build_empty_scope_prompt_cot`
- `_build_empty_scope_prompt_original`
- `_run_once`
- `_measure_task`
- `_print_comparison`
- `main`
...
- `_init_git_repo`
- `test_collect_symbols_excludes_untracked_in_git_repo`
- `test_collect_symbols_non_git_dir_falls_back_to_walk`
- `test_collect_symbols_git_repo_with_no_tracked_falls_back`
...
**Functions:**
- `test_md_has_common_marker`
- `test_toml_has_common_marker`
- `test_md_has_rich_marker`
...
## `tests/test_interactive_chat_output_cmd.py`

**Functions:**
- `_make_chat`
- `test_set_output_dir_changes_workspace`
- `test_set_output_dir_creates_missing_folder`
- `test_set_output_dir_strips_surrounding_quotes`
- `test_set_output_dir_expands_user`
- `test_set_output_dir_empty_is_rejected`
- `test_handle_command_output_no_arg_prints_current`
- `test_handle_command_output_with_arg_sets`
- `test_handle_command_output_preserves_path_case`
- `test_handle_command_unknown_returns_false`
- `test_banner_shows_output_folder`
...
- `test_roundtrip_with_empty_body_and_links`
- `test_roundtrip_body_with_triple_dash`
- `test_from_md_crlf_normalized`
- `test_from_md_rejects_missing_frontmatter`
- `test_frontmatter_is_yaml_compatible_inline`
- `test_new_note_created_commit_matches_head`
- `test_new_note_stamps_machine_and_author`
- `test_new_note_id_namespace_shape`
- `test_new_note_rejects_invalid_type`
- `test_new_note_roundtrips`
- `test_id_has_no_windows_unsafe_chars`
- `test_make_id_uses_microsecond_resolution`
- `test_make_id_collision_avoidance_with_rand`
...
## `tests/test_knowledge_wiki_stage0.py`
...
**Functions:**
- `test_general_folder_resolves_in_place`
- `test_deployed_user_creates_in_cwd`
- `test_inside_af_repo_redirects_to_projects`
- `test_inside_af_repo_subdir_redirects`
- `test_inside_projects_dir_resolves_in_place`
- `test_explicit_out_overrides_redirect`
- `test_explicit_out_expands_user`
- `test_slug_from_task_input`
- `test_slug_length_capped`
- `test_empty_task_input_falls_back_to_default`
- `test_is_within_exact_match`
- `test_is_within_subdir`
- `test_is_within_sibling_not_matched`
- `test_redirect_case_insensitive_on_windows`
- `test_dogfood_path_unaffected`
...
**Functions:**
- `test_notice_includes_per_provider_reauth_command`
- `test_notice_includes_skip_escape_hatch`
- `test_notice_multiple_providers_comma_joined_skip`
- `test_notice_empty_returns_empty`
- `test_reauth_commands_cover_all_known_providers`
- `_mock_installed`
- `_fake_auth_expired_run`
- `test_blocked_provider_detected_before_skip`
- `test_skip_provider_removes_from_blocked_no_reping`
- `test_skipped_provider_masked_as_not_installed`
...
- `test_prepare_brief_sets_target_path_to_workspace`
- `_prepared_brief`
- `_run_prepare_documents_with_mocks`
- `test_prepare_documents_resolves_relative_target_path_against_workspace`
